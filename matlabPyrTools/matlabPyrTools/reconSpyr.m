...
if (exist('bands','var') ~= 1)
  bands = 'all';
end

%%------------------------------------------------------------

if (isstr(filtfile) & (exist(filtfile,'file') == 2))
...
if any(levs == 0)
%    AR: new version of matlab does not allow this code to proceed without
%    returning an output, so i removed the argument that requests the code
%    to put the result in the "res" matrix.    
